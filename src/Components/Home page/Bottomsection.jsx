                        ...
                        <div className="col-lg-7 col-12 mt-4">
                            <div className={`card ${Styles.skillcard} p-3`} style={{ backgroundColor: "#FAFAFE" }}>
                                ...
                                <div className='d-inline-block'>
                                    <img src={html} alt="image"  className={`${Styles.skillicon} me-4 ms-4`} />
                                    <img src={css} alt="image"  className={`${Styles.skillicon} me-4`} />
                                    <img src={js} alt="image"  className={`${Styles.skillicon} me-4`} />
                                    <img src={react} alt="image"  className={`${Styles.skillicon} me-4`} />
                                    <img src={bootstrap} alt="image"  className={`${Styles.skillicon} me-4`} />
                                    <img src={git} alt="image"  className={`${Styles.skillicon} me-4`} />
                                    <img src={nodejs} alt="image"  className={`${Styles.skillicon}`} />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-5 col-12 mt-4">
                            <div className={`card ${Styles.skillcard} p-3 text-center d-flex justify-content-center`} style={{ backgroundColor: "#FAFAFE" }}>
                                ...
                                <div className={`signature`}>
                                    <svg width="250" height="50" viewBox="0 0 250 60" className={`${Styles.svg}`}>
                                        <path
