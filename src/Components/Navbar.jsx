        ...
        <>
            <nav className="navbar navbar-expand-lg sticky-top top-0" style={{ backgroundColor: "#F9F9FE", borderBottom: "1px solid #e2e6f7", boxShadow: "rgba(0, 0, 0, 0.05) 0px 1px 2px 0px" }}>
                <div className="container-fluid">
                    ...
                    <Link to={"#"} className='me-5 d-none d-md-block' data-aos="fade-left" data-aos-offset="500" data-aos-duration="1000" data-aos-anchor="#example-anchor"><button className={`btn ${Styles.connect_btn}`}><i className="bi bi-send me-2"></i>Let's Connect</button></Link>
                </div>
            </nav>
        </>
    )
